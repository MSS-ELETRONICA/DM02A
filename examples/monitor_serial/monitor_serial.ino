/*
EXEMPLO: ACIONAMENTO DE APENAS UM MÓDULO DE 2 CANAIS SEM ATUALIZAÇÃO DO NÍVEL ATUAL PELO FEEDBACK, APENAS SOLICITA O FEEDBACK MANUALMENTE
...
char nivel_1 = 0;   //Armazena internamente um nível, mas se mudar o nível pelos botões da placa esse valor não será atualizado, nesse caso terá que ler os nível de cada canal com a função feedback.
char nivel_2 = 0;
